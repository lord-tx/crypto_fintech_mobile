...
const String ksPrivacyText = "By signing up you agree to our term of use and privacy policy";
const String ksSignInClickableText = "Already have an account? Sign In";
